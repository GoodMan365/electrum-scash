...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/windows/fresh_clone/electrum-scash"
...
docker run $DOCKER_RUN_FLAGS \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/wine64/drive_c/electrum-scash \
    --rm \
    --workdir /opt/wine64/drive_c/electrum-scash/contrib/build-wine \
