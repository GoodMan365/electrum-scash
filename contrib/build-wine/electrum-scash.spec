...
PYPKG="electrum"
MAIN_SCRIPT="run_electrum-scash"
PROJECT_ROOT = "C:/electrum-scash"
#PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
ICONS_FILE=f"{PROJECT_ROOT}/{PYPKG}/gui/icons/electrum-scash.ico"
...
hiddenimports += [
    f"electrum.wizard",
    f"electrum.gui.qt.wizard.wallet",  # if needed
]
...
a = Analysis([f"{PROJECT_ROOT}/{MAIN_SCRIPT}",
              f"{PROJECT_ROOT}/{PYPKG}/wizard.py",
