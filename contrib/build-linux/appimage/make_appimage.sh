...
APPDIR="$BUILDDIR/electrum-scash.AppDir"
...
cp "$PROJECT_ROOT/electrum-scash.desktop" "$APPDIR/electrum-scash.desktop"
cp "$PROJECT_ROOT/electrum/gui/icons/electrum-scash.png" "$APPDIR/electrum-scash.png"
